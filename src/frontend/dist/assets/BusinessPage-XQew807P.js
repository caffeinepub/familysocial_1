import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, w as Dialog, y as DialogContent, z as DialogHeader, A as DialogTitle, L as Label, I as Input, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, a6 as DialogFooter, B as Button, T as Tabs, a as TabsList, b as TabsTrigger, d as TabsContent, a8 as ScrollArea, V as Plus, u as ue, k as Badge, x as DialogTrigger, s as Switch, W as Building2, t as CircleCheck, ab as Separator, R as React, M as MapPin, Z as Zap, f as Star, O as Sparkles, a2 as X } from "./index-CTlHP6rz.js";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-Cq_2D833.js";
import { P as Popover, a as PopoverTrigger, b as PopoverContent } from "./popover-DCPzBqmV.js";
import { P as Progress } from "./progress-DszDKqdf.js";
import { R as RadioGroup, a as RadioGroupItem } from "./radio-group-ZgVt5zbd.js";
import { S as Slider } from "./slider-Cja7jYlo.js";
import { T as Textarea } from "./textarea-DN_5fxc7.js";
import { B as BoostPostDialog } from "./BoostPostDialog-BmfPK1FK.js";
import { D as DiscoverClaimTab, R as ReviewModal } from "./ReviewModal-9sVn6_cV.js";
import { V as VendorOrdersPanel, C as CourierDispatchBusinessPanel, G as GarmentsModule, S as SweeperModule, M as MechanicModule, E as ElectricianModule, a as ElectricalModule, P as PlumbingModule, F as FoodParcelDeliveryModule, W as WaterDeliveryModule, T as TransportModule, b as FuelDepotModule, c as CourierDispatchModule } from "./BusinessModulesExtra-D_NNhpKy.js";
import { P as Pencil } from "./pencil-Le4Nlf1N.js";
import { T as Trash2 } from "./trash-2-B3FJtFdn.js";
import { D as DeliveryPartnersPanel } from "./DeliveryPartnersPanel-BgB-lWKU.js";
...
import { Q as QrCode } from "./qr-code-Ly5bvy5V.js";
...
import { M as Mail } from "./mail-Cr6WRfNz.js";
import { D as Download } from "./download-D_JD-x9I.js";
import "./PaymentModal-CgmZ4MA_.js";
import "./checkbox-CjuE3CBu.js";
import "./table-BZIkGW31.js";
import "./circle-x-BbF3NuTV.js";
import "./gavel-BgohycIZ.js";
import "./trending-up-cP0mEbep.js";
import "./wrench-Bq8AOBf8.js";
import "./droplets-DzOHEOk8.js";
...
function InventoryModule() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryCard, { label: "Total SKUs", value: stock.length }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SummaryCard,
        {
          label: "Low Stock",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "stock", className: "mt-3 space-y-3", children: [
          ...
          Dialog,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: editId !== null ? "Edit Stock Item" : "Add Stock Item" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: stock.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b last:border-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "pr-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
...
function AssemblyModule() {
  ...
  const [asmDialog, setAsmDialog] = reactExports.useState(false);
  const [asmEdit, setAsmEdit] = reactExports.useState(null);
  const [asmForm, setAsmForm] = reactExports.useState({
    product: "",
    qty: "",
    due: "",
    status: "Planned"
  ...
  const saveAsm = () => {
    ...
    if (asmEdit) {
      setOrders(
        (o) => o.map(
          (r) => r.id === asmEdit.id ? { ...r, ...asmForm, qty: Number(asmForm.qty) } : r
        )
      );
      ...
      ue.success("Order added");
    }
    setAsmDialog(false);
  };
  const deleteAsm = (id) => {
    setOrders(
      (o) => o.filter((r) => r.id !== id)
    );
    ue.success("Deleted");
  };
  const bom = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: asmDialog, onOpenChange: setAsmDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: asmEdit ? "Edit Order" : "Add Production Order" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              ...
              onChange: (e) => setAsmForm((f) => ({ ...f, product: e.target.value })),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              type: "number",
              value: asmForm.qty,
              onChange: (e) => setAsmForm((f) => ({ ...f, qty: e.target.value })),
              placeholder: "0"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              value: asmForm.due,
              onChange: (e) => setAsmForm((f) => ({ ...f, due: e.target.value })),
              placeholder: "Apr 20"
            }
          )
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setAsmDialog(false), children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: saveAsm, children: "Save" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "orders", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "orders", className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-56", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 6, className: "py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              size: "sm",
              variant: "outline",
          ...
          orders.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b last:border-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: statusBadge(r.status) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "flex gap-1 py-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  size: "sm",
...
function RepairServiceModule() {
  ...
  const [open, setOpen] = reactExports.useState(false);
  const [editJobId, setEditJobId] = reactExports.useState(null);
  const [form, setForm] = reactExports.useState({
    customer: "",
    item: "",
    issue: "",
  ...
  function addJob() {
    if (editJobId !== null) {
      setJobs(
        (j) => j.map((job) => job.id === editJobId ? { ...job, ...form } : job)
      );
      ue.success("Job card updated");
      setEditJobId(null);
    } else {
      setJobs((j) => [
        ...j,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "jobs", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "jobs", className: "mt-3 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open, onOpenChange: setOpen, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: editJobId !== null ? "Edit Job Card" : "New Job Card" }) }),
...
function FinancialModule() {
  ...
  const [editTxnId, setEditTxnId] = reactExports.useState(null);
  const [txnOpen, setTxnOpen] = reactExports.useState(false);
  const [txnForm, setTxnForm] = reactExports.useState({
    date: "",
    desc: "",
    debit: "",
    credit: "",
  ...
  function saveTxn() {
    if (editTxnId !== null) {
      setTxns(
        (t) => t.map((tx) => tx.id === editTxnId ? { ...tx, ...txnForm } : tx)
      );
  ...
  function deleteTxn(id) {
    if (window.confirm("Delete this transaction?")) {
      setTxns((t) => t.filter((tx) => tx.id !== id));
      ue.success("Item removed");
    }
  }
  const invoices = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "txns", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "txns", className: "mt-3 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Dialog,
          {
            open: txnOpen,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", children: "+ Add Transaction" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: editTxnId !== null ? "Edit Transaction" : "Add Transaction" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: ["date", "desc", "debit", "credit", "cat"].map(
                  (f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "capitalize", children: f === "cat" ? "Category" : f === "desc" ? "Description" : f }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                      {
                        value: txnForm[f],
                        onChange: (e) => setTxnForm((p) => ({ ...p, [f]: e.target.value }))
                      }
                    )
                  ] }, f)
                ) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(DialogFooter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: saveTxn, children: "Save" }) })
              ] })
            ]
          }
        ) }),
...
function TelecomModule() {
  ...
  const [telDialog, setTelDialog] = reactExports.useState(false);
  const [telEdit, setTelEdit] = reactExports.useState(null);
  const [telForm, setTelForm] = reactExports.useState({
    sim: "",
    customer: "",
    plan: "1GB/day",
    status: "Active",
  ...
  const saveTel = () => {
    ...
    if (telEdit) {
      setConns(
        (c) => c.map(
          (r) => r.sim === telEdit.sim ? { ...r, ...telForm } : r
        )
      );
      ue.success("Updated");
    } else {
      setConns((c) => [...c, { ...telForm }]);
      ue.success("Added");
    }
    setTelDialog(false);
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: telDialog, onOpenChange: setTelDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: telEdit ? "Edit Connection" : "Add SIM Connection" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "SIM Number" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: telForm.sim,
              onChange: (e) => setTelForm((f) => ({ ...f, sim: e.target.value })),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              ...
              onChange: (e) => setTelForm((f) => ({ ...f, customer: e.target.value })),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              value: telForm.plan,
              onChange: (e) => setTelForm((f) => ({ ...f, plan: e.target.value })),
              placeholder: "2GB/day"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Validity" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: telForm.validity,
              onChange: (e) => setTelForm((f) => ({ ...f, validity: e.target.value })),
              placeholder: "Apr 30"
            }
          )
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setTelDialog(false), children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: saveTel, children: "Save" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "conns", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "conns", className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-56", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
          ...
          conns.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b last:border-0", children: [
...
function RetailShopModule() {
  ...
  const [loyalty, setLoyalty] = reactExports.useState(() => {
    try {
  ...
  const [catDialog, setCatDialog] = reactExports.useState(false);
  const [catEdit, setCatEdit] = reactExports.useState(null);
  const [catForm, setCatForm] = reactExports.useState({ name: "", price: "" });
  const [loyDialog, setLoyDialog] = reactExports.useState(false);
  const [loyEdit, setLoyEdit] = reactExports.useState(
    null
  );
  const [loyForm, setLoyForm] = reactExports.useState({
    name: "",
    points: "",
    tier: "Silver",
    last: ""
  ...
  const saveCat = () => {
    ...
    if (catEdit) {
      setCatalog(
        (c) => c.map(
          (r) => r.name === catEdit.name ? { name: catForm.name, price: Number(catForm.price) } : r
        )
      );
      ue.success("Updated");
    } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "bill", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "bill", className: "mt-3 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", onClick: openCatAdd, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 12, className: "mr-1" }),
            "Add Item"
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "loyalty", className: "mt-3 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: loyDialog, onOpenChange: setLoyDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: loyEdit ? "Edit Customer" : "Add Loyalty Customer" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  value: loyForm.name,
                  onChange: (e) => setLoyForm((f) => ({ ...f, name: e.target.value })),
                  placeholder: "Customer name"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  onChange: (e) => setLoyForm((f) => ({ ...f, points: e.target.value })),
                  placeholder: "0"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                {
                  value: loyForm.tier,
                  onValueChange: (v) => setLoyForm((f) => ({ ...f, tier: v })),
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Last Visit" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  value: loyForm.last,
                  onChange: (e) => setLoyForm((f) => ({ ...f, last: e.target.value })),
                  placeholder: "Apr 1"
                }
              )
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setLoyDialog(false), children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: saveLoy, children: "Save" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
        ...
        loyalty.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-3 flex justify-between items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: catDialog, onOpenChange: setCatDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: catEdit ? "Edit Item" : "Add Catalog Item" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setCatDialog(false), children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: saveCat, children: "Save" })
      ] })
    ] }) })
  ] });
}
function VehicleModule() {
  ...
  const [vehDialog, setVehDialog] = reactExports.useState(false);
  const [vehEdit, setVehEdit] = reactExports.useState(
    null
  );
  const [vehForm, setVehForm] = reactExports.useState({
    make: "",
    model: "",
    year: "",
    color: "",
  ...
  const saveVeh = () => {
    ...
    if (vehEdit) {
      setInventory(
        (v) => v.map(
          (r) => r.make + r.model === vehEdit.make + vehEdit.model ? entry : r
        )
      );
      ue.success("Updated");
    } else {
  ...
  const deleteVeh = (make, model) => {
    setInventory(
      (v) => v.filter((r) => !(r.make === make && r.model === model))
    );
    ue.success("Deleted");
  };
  const drives = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: vehDialog, onOpenChange: setVehDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: vehEdit ? "Edit Vehicle" : "Add Vehicle" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                value: vehForm.make,
                onChange: (e) => setVehForm((f) => ({ ...f, make: e.target.value })),
                placeholder: "Maruti"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                value: vehForm.model,
                onChange: (e) => setVehForm((f) => ({ ...f, model: e.target.value })),
                placeholder: "Swift"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "number",
                value: vehForm.year,
                onChange: (e) => setVehForm((f) => ({ ...f, year: e.target.value })),
                placeholder: "2024"
              }
            )
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              value: vehForm.price,
              onChange: (e) => setVehForm((f) => ({ ...f, price: e.target.value })),
              placeholder: "₹8.5L"
            }
          )
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setVehDialog(false), children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: saveVeh, children: "Save" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "inv", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "inv", className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-56", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 7, className: "py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              size: "sm",
              variant: "outline",
          ...
          inventory.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b last:border-0", children: [
...
function LeadCRMModule() {
  ...
  const [leadDialog, setLeadDialog] = reactExports.useState(false);
  const [leadEdit, setLeadEdit] = reactExports.useState(
    null
  );
  ...
  const saveLead = () => {
    ...
    if (leadEdit) {
      setLeads(
        (l) => l.map((r) => r.name === leadEdit.name ? { ...leadForm } : r)
      );
      ue.success("Updated");
    } else {
      setLeads((l) => [...l, { ...leadForm }]);
      ue.success("Lead added");
    }
    setLeadDialog(false);
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: leadDialog, onOpenChange: setLeadDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: leadEdit ? "Edit Lead" : "Add Lead" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Company / Lead Name" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: leadForm.name,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Deal Value" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setLeadDialog(false), children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: saveLead, children: "Save" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "pipeline", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "pipeline", className: "mt-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            size: "sm",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 min-w-max pb-2", children: stages.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-40 flex-shrink-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-0.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { size: 9 })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 9 })
                  }
                )
              ] })
            ] }),
...
function SoftwareProjectModule() {
  ...
  const [swDialog, setSwDialog] = reactExports.useState(false);
  const [swEdit, setSwEdit] = reactExports.useState(
    null
  );
  const [swForm, setSwForm] = reactExports.useState({
    name: "",
    client: "",
    start: "",
    deadline: "",
  ...
  const saveSw = () => {
    ...
    if (swEdit) {
      setProjects(
        (p) => p.map((r) => r.name === swEdit.name ? { ...swForm } : r)
      );
      ue.success("Updated");
    } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: swDialog, onOpenChange: setSwDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: swEdit ? "Edit Project" : "Add Project" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              value: swForm.client,
              onChange: (e) => setSwForm((f) => ({ ...f, client: e.target.value })),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                value: swForm.start,
                onChange: (e) => setSwForm((f) => ({ ...f, start: e.target.value })),
                placeholder: "Jan 1"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                onChange: (e) => setSwForm((f) => ({ ...f, deadline: e.target.value })),
                placeholder: "Dec 31"
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              value: swForm.budget,
              onChange: (e) => setSwForm((f) => ({ ...f, budget: e.target.value })),
              placeholder: "₹2L"
            }
          )
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setSwDialog(false), children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: saveSw, children: "Save" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "projects", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "projects", className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
          ...
          projects.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b last:border-0", children: [
...
function MoneyLendingModule() {
  ...
  const [loanDialog, setLoanDialog] = reactExports.useState(false);
  const [loanEdit, setLoanEdit] = reactExports.useState(
    null
  );
  const [loanForm, setLoanForm] = reactExports.useState({
    borrower: "",
    amt: "",
    rate: "",
    tenure: "",
  ...
  const saveLoan = () => {
    ...
    if (loanEdit) {
      setLoans(
        (l) => l.map((r) => r.id === loanEdit.id ? { ...r, ...loanForm } : r)
      );
      ue.success("Updated");
    } else {
      setLoans((l) => [...l, { id: `L-${Date.now()}`, ...loanForm }]);
      ue.success("Loan added");
    }
    setLoanDialog(false);
  };
  const deleteLoan = (id) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: loanDialog, onOpenChange: setLoanDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: loanEdit ? "Edit Loan" : "Add Loan" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Borrower Name" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                value: loanForm.amt,
                onChange: (e) => setLoanForm((f) => ({ ...f, amt: e.target.value })),
                placeholder: "₹50,000"
              }
            )
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Tenure" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Disbursed Date" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                value: loanForm.disbursed,
                onChange: (e) => setLoanForm((f) => ({ ...f, disbursed: e.target.value })),
                placeholder: "Jan 1"
              }
            )
          ] })
            ...
            Select,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Defaulted", children: "Defaulted" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setLoanDialog(false), children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: saveLoan, children: "Save" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "loans", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "loans", className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-56", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 8, className: "py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              size: "sm",
              variant: "outline",
          ...
          loans.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b last:border-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-1.5 pr-2 font-mono text-xs", children: r.id }),
...
function isApparelCategory(cat) {
  const lower = cat.toLowerCase();
  return lower.includes("apparel") || lower.includes("clothing") || lower.includes("fashion") || lower.includes("garment") || cat === "Fashion";
}
function isAccessoriesCategory(cat) {
  const lower = cat.toLowerCase();
  return lower.includes("accessories") || lower.includes("jewelry") || lower.includes("bags") || lower.includes("footwear");
}
function detectVariantsForCategory(category, basePrice) {
  ...
  if (isAccessoriesCategory(category)) {
    const colors = APPAREL_COLORS.slice(0, 5);
    return colors.flatMap(
      (color) => ACCESSORIES_MATERIALS.slice(0, 3).map((mat) => ({
        label: `${color} / ${mat}`,
        price: basePrice || "0",
        stock: "10"
      }))
...
function POSProductsTab() {
  ...
  const handleImageUpload = (e) => {
    ...
    if (!file) return;
    if (isApparelCategory(form.category) || isAccessoriesCategory(form.category)) {
      const nameLower = file.name.toLowerCase();
      const autoColors = APPAREL_COLORS.filter(
        (c) => nameLower.includes(c.toLowerCase().replace(" ", "")) || nameLower.includes(c.toLowerCase().split(" ")[0])
      );
      if (autoColors.length > 0) {
        setDetectedColors(autoColors);
        ue.info(`Detected colors: ${autoColors.join(", ")}`);
      }
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    showForm && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-xl border-border", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
        ...
        (isApparel || isAccessories) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 p-3 rounded-lg border border-violet-500/20 bg-violet-500/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold text-violet-700 dark:text-violet-400", children: "🎨 Color Detection" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: (isApparel ? APPAREL_COLORS : APPAREL_COLORS.slice(0, 8)).map((color) => {
          ...
          detectedColors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              onClick: () => {
                const sizes = isApparel ? ["S", "M", "L", "XL"] : ACCESSORIES_SIZES.slice(0, 3);
                const newVariants = detectedColors.flatMap(
                  (color) => sizes.map((size) => ({
                    label: `${color} / ${size}`,
                    price: form.price || "0",
                    stock: "10"
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-xs", children: [
              isApparel || isAccessories ? "Color / Size Variants" : "Variants",
              variants.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground ml-1", children: [
                "(",
                variants.length,
                ")"
              ] })
          ...
          variants.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-border rounded-lg overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-1.5 text-left font-medium", children: isApparel ? "Color / Size" : isAccessories ? "Color / Material" : "Label" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-1.5 text-left font-medium", children: "Price (₹)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-1.5 text-left font-medium", children: "Stock" }),
          ...
          ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground italic", children: "No variants yet. Click Auto-detect or + Add to add variants." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold", children: "Add-ons" }),
          addonSuggestions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "Quick add:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: addonSuggestions.map((s) => {
          ...
          addons.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 bg-muted/40 rounded px-2 py-1 truncate", children: a.name }),
