const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CyqfqUsz.js","assets/index-BWvszrtO.js","assets/index-Bys2wK3T.css"])))=>i.map(i=>d[i]);
import { k as createLucideIcon, r as reactExports, aI as createDialogScope, j as jsxRuntimeExports, ac as Root, aJ as Trigger, ax as useComposedRefs, aK as WarningProvider, at as createContextScope, ad as Content, av as composeEventHandlers, aL as createSlottable, ag as Title, aM as Description, af as Close, ah as Portal, ai as Overlay, ae as cn, aN as buttonVariants, aO as useActor, a6 as useInternetIdentity, aP as loadConfig, ar as __vitePreload, aQ as StorageClient, aR as useSaveUserProfile, U as User, A as Avatar, aS as AvatarImage, b as AvatarFallback, a as Button, L as Label, I as Input, S as Select, f as SelectTrigger, g as SelectValue, h as SelectContent, i as SelectItem, al as Shield, a0 as Switch, x as Separator, t as Bell, u as ue, ak as LoaderCircle, M as MessageCircle, w as CircleCheck } from "./index-BWvszrtO.js";
...
import { D as Download } from "./download-DLXlDF9q.js";
import { T as Trash2 } from "./trash-2-Cs4yvDPJ.js";
import { U as Upload } from "./upload-pTBRc3nx.js";
/**
  ...
  const uploadFile = reactExports.useCallback(
    async (file) => {
      ...
      const { HttpAgent } = await __vitePreload(async () => {
        const { HttpAgent: HttpAgent2 } = await import("./index-CyqfqUsz.js").then((n) => n.i);
