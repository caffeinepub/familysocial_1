const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Dh54BS9K.js","assets/index-Daa_jkDV.js","assets/index-8w08yt9g.css"])))=>i.map(i=>d[i]);
import { o as createLucideIcon, r as reactExports, au as createDialogScope, j as jsxRuntimeExports, R as Root, av as Trigger, ae as useComposedRefs, aw as WarningProvider, aa as createContextScope, N as Content, ac as composeEventHandlers, ax as createSlottable, V as Title, ay as Description, Q as Close, W as Portal, Y as Overlay, O as cn, az as buttonVariants, aA as useActor, aB as useInternetIdentity, aC as loadConfig, aD as __vitePreload, aE as StorageClient, aF as useSaveUserProfile, A as Avatar, aG as AvatarImage, m as AvatarFallback, B as Button, L as Label, I as Input, S as Select, e as SelectTrigger, f as SelectValue, g as SelectContent, h as SelectItem, T as Textarea, v as Switch, a7 as Bell, u as ue, aH as LoaderCircle } from "./index-Daa_jkDV.js";
...
import { D as Database } from "./index-Dh54BS9K.js";
  ...
  const uploadFile = reactExports.useCallback(
    async (file) => {
      ...
      const { HttpAgent } = await __vitePreload(async () => {
        const { HttpAgent: HttpAgent2 } = await import("./index-Dh54BS9K.js").then((n) => n.i);
