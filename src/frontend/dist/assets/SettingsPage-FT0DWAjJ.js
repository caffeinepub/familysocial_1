const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DOhk8rCv.js","assets/index-BfRdVjGV.js","assets/index-C6ivjVMQ.css"])))=>i.map(i=>d[i]);
import { g as createLucideIcon, r as reactExports, aC as createDialogScope, j as jsxRuntimeExports, a3 as Root, aD as Trigger, aj as useComposedRefs, aE as WarningProvider, af as createContextScope, a4 as Content, ah as composeEventHandlers, aF as createSlottable, a7 as Title, aG as Description, a6 as Close, a8 as Portal, a9 as Overlay, a5 as cn, aH as buttonVariants, aI as useActor, ab as useInternetIdentity, aJ as loadConfig, aK as __vitePreload, aL as StorageClient, aM as useSaveUserProfile, U as User, A as Avatar, aN as AvatarImage, b as AvatarFallback, a as Button, L as Label, I as Input, S as Select, c as SelectTrigger, d as SelectValue, e as SelectContent, f as SelectItem, R as Switch, s as Separator, o as Bell, u as ue, ac as LoaderCircle, M as MessageCircle, q as CircleCheck } from "./index-BfRdVjGV.js";
...
import { D as Database } from "./index-DOhk8rCv.js";
  ...
  const uploadFile = reactExports.useCallback(
    async (file) => {
      ...
      const { HttpAgent } = await __vitePreload(async () => {
        const { HttpAgent: HttpAgent2 } = await import("./index-DOhk8rCv.js").then((n) => n.i);
