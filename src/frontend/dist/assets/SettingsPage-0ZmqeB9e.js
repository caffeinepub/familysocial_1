...
import { D as Download } from "./download-Ceqs0K-u.js";
  ...
  const uploadFile = reactExports.useCallback(
    async (file) => {
      ...
      const { HttpAgent } = await __vitePreload(async () => {
        const { HttpAgent: HttpAgent2 } = await import("./index-CQbW8kI5.js").then((n) => n.i);
