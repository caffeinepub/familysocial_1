import { r as reactExports, u as ue, j as jsxRuntimeExports, H as Heart, a as Button, U as User, A as Avatar, b as AvatarFallback, B as Badge, T as Tabs, c as TabsList, d as TabsTrigger, e as TabsContent, _ as Search, I as Input, S as Select, f as SelectTrigger, g as SelectValue, h as SelectContent, i as SelectItem, $ as ChevronDown, L as Label, a0 as React, C as Check, X, k as Star, W as BookOpen, a1 as Switch } from "./index-CCkd8W3P.js";
import { C as Card, b as CardContent, a as CardHeader } from "./card-Dw4L-nn3.js";
...
import { F as Funnel } from "./funnel-CduOagLy.js";
...
const MatchCard = React.memo(function MatchCard2({
  profile,
  onShortlist,
  onSendRequest,
  onViewProfile,
...
function getHoroScore(compat) {
  return { Excellent: 100, Good: 75, Neutral: 50, Challenging: 25 }[compat] ?? 50;
}
function getCombinedScore(profile) {
...
function QuestionnaireTab({
  ...
  const findMatches = () => {
    const matches = MOCK_PROFILES.filter((p) => {
      ...
      if (answers.caste && !p.caste.toLowerCase().includes(answers.caste.toLowerCase()))
        return false;
      if (answers.religion !== "all" && p.sect !== answers.religion)
        return false;
      if (answers.city && !p.city.toLowerCase().includes(answers.city.toLowerCase()))
        return false;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: results === null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg mx-auto space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: [1, 2, 3, 4].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs(React.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: n <= step ? { background: "oklch(0.55 0.22 280)" } : {},
          children: n < step ? "✓" : n
        }
      ),
      n < 4 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg", children: "Age Range" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Minimum Age" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", children: answers.ageMin })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Slider,
            {
              ...
              onValueChange: ([v]) => setAnswers((a) => ({ ...a, ageMin: v }))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Maximum Age" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", children: answers.ageMax })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Slider,
            {
              ...
              onValueChange: ([v]) => setAnswers((a) => ({ ...a, ageMax: v }))
            }
          )
        ] })
      ] })
    ...
    step === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg", children: "Caste & Religion" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Caste Preference (optional)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              placeholder: "e.g. Syed, Brahmin...",
              value: answers.caste,
              onChange: (e) => setAnswers((a) => ({ ...a, caste: e.target.value }))
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Religion" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: answers.religion,
              onValueChange: (v) => setAnswers((a) => ({ ...a, religion: v })),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "Any Religion" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Sunni", children: "Sunni" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Shia", children: "Shia" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Hindu", children: "Hindu" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Sikh", children: "Sikh" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Christian", children: "Christian" })
                ] })
              ]
            }
          )
    ...
    step === 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg", children: "Location & Income" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "City (optional)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Income Range" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: answers.income,
              onValueChange: (v) => setAnswers((a) => ({ ...a, income: v })),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "Any Income" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "30k-60k", children: "₹30k–₹60k" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "60k-100k", children: "₹60k–₹100k" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "100k-200k", children: "₹1L–₹2L" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "200k+", children: "₹2L+" })
                ] })
              ]
            }
          )
    ...
    step === 4 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-lg", children: "Lifestyle & Horoscope" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Lifestyle" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: answers.lifestyle,
              onValueChange: (v) => setAnswers((a) => ({ ...a, lifestyle: v })),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "Any" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Simple", children: "Simple" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Moderate", children: "Moderate" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Luxury", children: "Luxury" })
                ] })
              ]
            }
          )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Partner's Horoscope Sign" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: answers.horoscope,
              onValueChange: (v) => setAnswers((a) => ({ ...a, horoscope: v })),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "Any Sign" }),
                  HOROSCOPE_SIGNS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: s, children: [
                    HOROSCOPE_EMOJI[s],
                    " ",
                    s
                  ] }, s))
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
      step > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setStep((s) => s - 1), children: "Back" }),
      step < 4 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "flex-1", onClick: () => setStep((s) => s + 1), children: "Next →" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          className: "flex-1",
          onClick: findMatches,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-semibold text-lg", children: [
        results.length,
        " Match",
        results.length !== 1 ? "es" : "",
        " Found"
    ...
    results.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: "💫" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: "No matches found." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", children: "Try widening your filters." })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 md:grid-cols-2", children: results.map((p) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 pl-5 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CompatibilityBadge, { score: p.compatibilityScore })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: HOROSCOPE_EMOJI[p.horoscope] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: p.horoscope }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
              "· Guna: ",
              getGunaScore(combined),
              "/36"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/50 rounded-lg p-3 text-xs text-muted-foreground italic", children: advice }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              size: "sm",
...
function MatrimonyPage() {
  ...
  const toggleShortlist = reactExports.useCallback((id) => {
    setShortlisted((prev) => {
  ...
  const sendRequest = reactExports.useCallback(
    (id) => {
  ...
  const astroMatches = reactExports.useMemo(() => {
    return [...MOCK_PROFILES].map((p) => ({ p, combined: getCombinedScore(p) })).sort((a, b) => b.combined - a.combined).slice(0, 5).map(({ p, combined }) => ({ profile: p, combined }));
  }, []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 lg:p-6 space-y-6 min-h-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "browse", className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "font-label flex-wrap h-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "astro", children: "⭐ Astro Matches" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "questionnaire", children: "🔍 Find My Match" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "astro", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
                  ...
                  children: [
                    "♎ Your sign: ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: MY_HOROSCOPE }),
                    " · Ruling planet:",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: RULING_PLANET[MY_HOROSCOPE] })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Top 5 astro-compatible matches ranked by Guna Milan + compatibility score" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 md:grid-cols-2", children: astroMatches.map(({ profile: p, combined }) => {
            ...
            Card,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-bold text-base", children: [
                        p.name,
                        ", ",
                        p.age
                      ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-xs", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-lg p-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Horoscope" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-semibold", children: [
                        HOROSCOPE_EMOJI[p.horoscope],
                        " ",
                        p.horoscope
                      ] }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-lg p-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Guna Milan" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "p",
                        {
                          className: "font-bold text-base",
                          style: {
                            color: gunaScore >= 25 ? "oklch(0.52 0.18 155)" : "oklch(0.72 0.19 85)"
                          },
                          children: [
                            gunaScore,
                            "/36"
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-lg p-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Compatibility" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-lg p-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Muhurat Day" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: favorableDay })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "questionnaire", className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(QuestionnaireTab, { sendRequest }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ProfileDetailSheet,
      {
