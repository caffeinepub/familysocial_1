const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DUrnqr09.js","assets/index-B_6s_bDY.js","assets/index-Dah6ZEDv.css"])))=>i.map(i=>d[i]);
import { l as createLucideIcon, r as reactExports, aY as createDialogScope, j as jsxRuntimeExports, ac as Root, aZ as Trigger, ax as useComposedRefs, a_ as WarningProvider, av as createContextScope, ad as Content, az as composeEventHandlers, a$ as createSlottable, ag as Title, b0 as Description, af as Close, ah as Portal, ai as Overlay, ae as cn, b1 as buttonVariants, b2 as useActor, a7 as useInternetIdentity, b3 as loadConfig, ar as __vitePreload, b4 as StorageClient, b5 as useSaveUserProfile, U as User, A as Avatar, b6 as AvatarImage, b as AvatarFallback, b7 as Camera, a as Button, L as Label, I as Input, S as Select, f as SelectTrigger, g as SelectValue, h as SelectContent, i as SelectItem, al as Shield, a1 as Switch, x as Separator, t as Bell, u as ue, ak as LoaderCircle, M as MessageCircle, w as CircleCheck } from "./index-B_6s_bDY.js";
  ...
  const uploadFile = reactExports.useCallback(
    async (file) => {
      ...
      const { HttpAgent } = await __vitePreload(async () => {
        const { HttpAgent: HttpAgent2 } = await import("./index-DUrnqr09.js").then((n) => n.i);
