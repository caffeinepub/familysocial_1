import { s as createLucideIcon, r as reactExports, j as jsxRuntimeExports, v as ShieldCheck, U as Users, w as TriangleAlert, Z as Zap, am as DropdownMenu, an as DropdownMenuTrigger, O as ChevronDown, ao as DropdownMenuContent, ap as DropdownMenuItem, a as Button, B as Badge, L as Label, I as Input, S as Select, f as SelectTrigger, g as SelectValue, h as SelectContent, i as SelectItem, u as ue, Y as ShoppingBag, Q as Switch, C as CircleCheck, M as MapPin, K as BookOpen, k as Briefcase } from "./index-DVrwA8ch.js";
import { C as Checkbox } from "./checkbox-DFutZuV-.js";
import { S as Slider } from "./slider-DZYRMdUz.js";
...
import { D as Database } from "./index-BNLlZDnb.js";
...
import { C as Crown } from "./crown-BxnmCjXd.js";
import { I as Image } from "./image-Bd5MuFvw.js";
import { L as Link2 } from "./link-2-DaO23JYG.js";
import { M as MessageSquare } from "./message-square-DBx0TcWV.js";
import { S as Share2 } from "./share-2-uix-I0rV.js";
import { S as Smartphone } from "./smartphone-D3wdG7yi.js";
import { D as DollarSign } from "./dollar-sign-pDI1X4U8.js";
...
const Factory = createLucideIcon("factory", __iconNode$4);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "overview", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: () => ue.success("Agoda sync started — fetching hotels..."),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "surveys", className: "mt-0 space-y-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "agent19", className: "mt-0 space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 space-y-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "User Interest Tags (comma separated)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    className: "mt-1",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Game Difficulty" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Game Type" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { defaultValue: "trivia", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "puzzle", children: "Puzzle" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "trivia", children: "Trivia" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "adventure", children: "Adventure" })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Auto-Generate (Daily)" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Switch,
                  {
                    defaultChecked: true,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  size: "sm",
                  className: "w-full",
                  onClick: () => ue.success("Game generation triggered"),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold", children: "Last Generated Games" }),
              [
                {
              ...
              ].map((game, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: game.name }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: game.date })
                  ]
                },
                game.name
              ))
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "agent20", className: "mt-0 space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold", children: "Configuration" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Humor Style" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { defaultValue: "witty", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectTrigger,
                    {
                      className: "mt-1",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "slapstick", children: "Slapstick" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "witty", children: "Witty" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "dry", children: "Dry" })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Content Source" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { defaultValue: "daily-feed", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "daily-feed", children: "Daily Feed" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "trending", children: "Trending Posts" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "community", children: "Community Events" })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Generation Frequency" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { defaultValue: "daily", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "daily", children: "Daily" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  size: "sm",
                  className: "w-full",
                  onClick: () => ue.success("Comic generated!"),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold", children: "Sample Comic Preview" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-0", children: [
                      {
                        panel: 1,
                      ...
                      "div",
                      {
                        ...
                        style: {
                          minHeight: "80px",
                          background: p.panel % 2 === 0 ? "oklch(var(--muted)/0.3)" : "transparent"
                        },
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-bold text-primary", children: [
                            "Panel ",
                            p.panel
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-muted-foreground", children: p.text })
                        ]
                      },
                      p.panel
                    )) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 text-center text-[10px] text-muted-foreground border-t border-border", children: "Generated by IC.ComicAgent · Today 8:00 AM" })
                  ]
                }
              )
            ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "rides-admin", className: "mt-0 space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(RideManagement, {})
        ] })
      ] })
    ] }),
...
function SocialMediaQueue() {
  const [items, setItems] = reactExports.useState([
    {
      id: 1,
      preview: "Check out our new organic honey range — now 20% off! Perfect for the health-conscious.",
    ...
    {
      id: 2,
      preview: "Just listed: 3BHK in Bandra West with sea view. Contact for pricing details.",
    ...
    {
      id: 3,
      preview: "Calling all foodies! Our weekend food festival is on March 20th. Free entry!",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TD, { className: "text-muted-foreground", children: item.user }),
              ...
              ] }) : item.status === "approved" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  size: "sm",
                  variant: "ghost",
...
function PromotionsQueue() {
  ...
  const approve = (id) => {
    ...
    ue.success("Promotion approved and published");
  };
  const reject = (id) => {
    setItems(
      (prev) => prev.map(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-muted/30", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TH, { children: "Ad Title" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TH, { children: "Module" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TH, { children: "Budget" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TH, { children: "18+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TH, { children: "User" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TH, { children: "Status" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TH, { children: "Actions" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TD, { className: "font-medium", children: item.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TD, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-1.5 py-0.5 rounded bg-primary/10 text-primary text-[10px]", children: item.module }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TD, { className: "font-semibold text-green-600", children: item.budget }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TD, { children: item.isAdult ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold px-1.5 py-0.5 rounded bg-red-500/10 text-red-600", children: "18+" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "—" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TD, { className: "text-muted-foreground", children: item.user }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TD, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                SBadge,
                {
              ...
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground capitalize", children: item.status }) })
            ]
          },
          item.id
        )) })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 space-y-4", children: [
      ...
      [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: field.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            className: "mt-1",
...
function RideManagement() {
  ...
  const [rates, setRates] = reactExports.useState(() => {
    ...
    try {
      ...
      return {
        taxi: {
          baseFare: ((_a = saved == null ? void 0 : saved.taxi) == null ? void 0 : _a.baseFare) ?? 50,
          perKm: ((_b = saved == null ? void 0 : saved.taxi) == null ? void 0 : _b.perKm) ?? 12,
          surge: ((_c = saved == null ? void 0 : saved.taxi) == null ? void 0 : _c.surgeMult) ?? 1.5
        },
        bike: {
          baseFare: ((_d = saved == null ? void 0 : saved.bike) == null ? void 0 : _d.baseFare) ?? 25,
          perKm: ((_e = saved == null ? void 0 : saved.bike) == null ? void 0 : _e.perKm) ?? 6,
          surge: ((_f = saved == null ? void 0 : saved.bike) == null ? void 0 : _f.surgeMult) ?? 1.2
        },
        auto: {
          baseFare: ((_g = saved == null ? void 0 : saved.auto) == null ? void 0 : _g.baseFare) ?? 30,
          perKm: ((_h = saved == null ? void 0 : saved.auto) == null ? void 0 : _h.perKm) ?? 8,
          surge: ((_i = saved == null ? void 0 : saved.auto) == null ? void 0 : _i.surgeMult) ?? 1.3
        }
      };
    } catch {
      return {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold", children: "Add Driver" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Taxi", children: "Taxi" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "License Plate" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                className: "mt-1",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold", children: "Rate Cards" }),
        Object.entries(rates).map(([type, r]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "p-3 rounded-lg bg-secondary/30 space-y-2",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold capitalize", children: type }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px]", children: "Base Fare (₹)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px]", children: "Per KM (₹)" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      className: "mt-0.5 h-8 text-xs",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px]", children: "Surge ×" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      className: "mt-0.5 h-8 text-xs",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold", children: "Registered Drivers" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-muted/30", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TH, { children: "License" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TH, { children: "Phone" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TH, { children: "Status" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: drivers.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            className: "border-b border-border/50 hover:bg-secondary/20",
            "data-ocid": `admin.rides.driver.row.${i + 1}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TD, { className: "font-medium", children: d.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TD, { children: d.vehicle }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TD, { className: "font-mono", children: d.license }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TD, { className: "text-muted-foreground", children: d.phone }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TD, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Switch,
                {
                  checked: d.status,
                  onCheckedChange: (v) => setDrivers(
                    (prev) => prev.map(
                      (dr) => dr.id === d.id ? { ...dr, status: v } : dr
                    )
                  ),
