import { s as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as Button, k as Briefcase, X, D as Dialog, c as DialogContent, d as DialogHeader, e as DialogTitle, G as DialogFooter, L as Label, I as Input, T as Textarea, u as ue, S as Select, f as SelectTrigger, g as SelectValue, h as SelectContent, i as SelectItem, N as Sparkles, B as Badge } from "./index-DVrwA8ch.js";
...
function GenericProductForm({
  ...
  const handleSubmit = () => {
    ...
    ue.success(`Product "${form.name}" added and linked to ${moduleName}`);
    onSubmit();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ImageUploadPanel, {}),
...
function GenericServiceForm({
  ...
  const handleSubmit = () => {
    ...
    ue.success(`Service "${form.name}" added and linked to ${moduleName}`);
    onSubmit();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
