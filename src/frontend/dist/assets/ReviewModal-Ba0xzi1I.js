import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, k as Badge, B as Button, ab as Clock, T as Tabs, a as TabsList, b as TabsTrigger, d as TabsContent, L as Label, a9 as ScrollArea, u as ue, w as Dialog, y as DialogContent, z as DialogHeader, A as DialogTitle, a7 as DialogFooter, S as ShieldCheck, ac as Separator, I as Input, X as Search, W as Building2, M as MapPin, E as LoaderCircle, $ as User, P as Package, x as DialogTrigger, f as Star } from "./index-BVgoOni7.js";
...
import { G as Gavel } from "./gavel-BC43fqcV.js";
...
function incrementApiQuota(apiName) {
  try {
...
function getApiQuota(apiName) {
  try {
    ...
    return (entry == null ? void 0 : entry.date) === today ? entry.count : 0;
  } catch {
    return 0;
  }
}
...
function generateGoogleResults(city, category) {
  ...
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      ...
      category,
      city,
      phone: `+91 ${Math.floor(7e9 + Math.random() * 2999999999)}`,
      status: "Unclaimed",
      rating,
...
async function fetchOsmBusinesses(city, category) {
  ...
  return data.map((r, i) => {
    ...
    const phone = ((_a = r.extratags) == null ? void 0 : _a.phone) || ((_b = r.extratags) == null ? void 0 : _b["contact:phone"]) || `+91 ${Math.floor(7e9 + Math.random() * 2999999999)}`;
    const website = ((_c = r.extratags) == null ? void 0 : _c.website) || "N/A";
    const rating = (3.5 + Math.random() * 1.5).toFixed(1);
    return {
...
function GoogleBusinessSearchTab({
  ...
  const [category, setCategory] = reactExports.useState("Healthcare");
  const [loading, setLoading] = reactExports.useState(false);
  const [results, setResults] = reactExports.useState([]);
  const [added, setAdded] = reactExports.useState(/* @__PURE__ */ new Set());
  const handleSearch = async () => {
    if (!city.trim()) {
      ue.error("Enter a city to search");
      return;
    }
    setLoading(true);
    setResults([]);
    try {
      ...
      if (found.length > 0) {
        ...
        ue.warning("No OSM results — showing sample results");
      }
    } catch {
      const simulated = generateGoogleResults(city.trim(), category);
      setResults(simulated);
      ue.error("External search unavailable — showing sample results");
    } finally {
      setLoading(false);
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-blue-500/10 border border-blue-500/20 text-xs text-blue-700 dark:text-blue-400 flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 14, className: "shrink-0 mt-0.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "Live search via ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "OpenStreetMap / Nominatim" }),
        ". Results show real place data — no API key required."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "select",
        {
          ...
          children: GOOGLE_BIZ_CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: cat, children: cat }, cat))
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 14, className: "animate-spin mr-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 14, className: "mr-1" }),
    ...
    results.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground font-medium", children: [
        results.length,
        " results found"
      ] }),
      results.map((biz, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: biz.name }),
                biz.rating && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-amber-600 font-medium", children: [
                  "⭐ ",
                  biz.rating
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              biz.address && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mt-0.5 text-xs text-muted-foreground", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-1 text-xs text-muted-foreground", children: [
                ...
                biz.website && biz.website !== "N/A" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href: biz.website,
                    target: "_blank",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "mt-1 text-[10px]", children: biz.category })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                onClick: () => {
                  onAddToBusiness(biz);
                  setAdded((prev) => /* @__PURE__ */ new Set([...prev, biz.id]));
                },
                "data-ocid": `admin.agent11.google.secondary_button.${i + 1}`,
                children: added.has(biz.id) ? "✓ Added" : "+ Add"
              }
            )
          ]
        },
    ...
    !loading && results.length === 0 && city && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "text-center py-8 text-muted-foreground text-sm",
        "data-ocid": "admin.agent11.google.empty_state",
        children: "No results yet. Click Search to discover businesses."
      }
    )
  ] });
}
...
function FindPeopleTab() {
      ...
      if (raw) {
        ...
        setLocalResults(
          users.filter(
            (u) => {
              var _a, _b, _c;
              return ((_a = u.name) == null ? void 0 : _a.toLowerCase().includes(q)) || ((_b = u.username) == null ? void 0 : _b.toLowerCase().includes(q)) || ((_c = u.email) == null ? void 0 : _c.toLowerCase().includes(q));
            }
          )
        );
      }
    ...
    try {
      ...
      if (resp.ok) {
        ...
        if ((data.items || []).length === 0) {
          ue.info("No GitHub users found for that keyword");
        }
      } else if (resp.status === 403) {
        ue.warning("GitHub API rate limit reached (60 req/hr). Try later.");
      } else {
        throw new Error(`HTTP ${resp.status}`);
      }
    } catch (err) {
      if (!String(err).includes("403")) {
        ue.error("GitHub search unavailable — check connection");
      }
    } finally {
      setLoading(false);
    }
  ...
  const addPerson = (person) => {
    ...
    setAdded((prev) => /* @__PURE__ */ new Set([...prev, person.id]));
    ue.success(`${person.name} added to Discovered People`);
  };
  const totalResults = githubResults.length + localResults.length;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-violet-500/10 border border-violet-500/20 text-xs text-violet-700 dark:text-violet-400 flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 14, className: "shrink-0 mt-0.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "Searches ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "GitHub" }),
        " (public profiles) and",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "IndyaCentral" }),
        " local users by name or keyword."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    loading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 16, className: "animate-spin" }),
          'Searching GitHub and IndyaCentral users for "',
          keyword,
          '"…'
        ]
      }
    ),
    searched && !loading && totalResults === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "text-center py-8 text-muted-foreground text-sm",
    ...
    localResults.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-muted-foreground", children: [
        "👤 IndyaCentral Users (",
        localResults.length,
        ")"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2", children: localResults.map((u, i) => {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center shrink-0", children: u.avatar ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: u.avatar,
                    alt: u.name,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium truncate", children: u.name }),
                  u.username && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground truncate", children: [
                    "@",
                    u.username
                  ] })
                ] }),
    ...
    githubResults.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-muted-foreground", children: [
        "GitHub Users (",
        githubResults.length,
        ")"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2", children: githubResults.map((u, i) => {
        const pid = `gh_${u.id}`;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium truncate", children: u.login }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                      href: u.html_url,
...
function FindProductsTab() {
  ...
  const [imported, setImported] = reactExports.useState(/* @__PURE__ */ new Set());
  const [searched, setSearched] = reactExports.useState(false);
  const handleSearch = async () => {
    if (!keyword.trim()) {
      ue.error("Enter a product keyword to search");
      return;
    }
    setLoading(true);
    setProducts([]);
    ...
    try {
      ...
      setProducts(items);
      if (items.length === 0) {
        ue.info("No products found — try a different keyword");
      } else {
        ue.success(`Found ${items.length} products from OpenFoodFacts`);
      }
    } catch {
      ue.error("OpenFoodFacts search unavailable — check connection");
    } finally {
      setLoading(false);
    }
  };
  const importProduct = (p) => {
    try {
      ...
      existing.unshift({
        ...
        description: p.brands ? `Brand: ${p.brands}` : "Imported from OpenFoodFacts",
    ...
    setImported((prev) => /* @__PURE__ */ new Set([...prev, p.code || ""]));
    ue.success(`${p.product_name} imported to Shop`);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-green-500/10 border border-green-500/20 text-xs text-green-700 dark:text-green-400 flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { size: 14, className: "shrink-0 mt-0.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "Live product search via ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "OpenFoodFacts" }),
        " (500 calls/day, free). Imported products appear instantly in Shop."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    loading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 16, className: "animate-spin" }),
          'Searching OpenFoodFacts for "',
          keyword,
          '"…'
        ]
      }
    ),
    searched && !loading && products.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "text-center py-8 text-muted-foreground text-sm",
    ...
    products.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2", children: products.map((p, i) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
              p.image_small_url || p.image_url ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
              ...
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-muted flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { size: 16, className: "text-muted-foreground" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium truncate", children: p.product_name }),
                p.brands && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground truncate", children: p.brands }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mt-0.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      ...
                      children: "🌐 OpenFoodFacts"
                    }
                  ),
                  p.categories && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground truncate max-w-[100px]", children: p.categories.split(",")[0] })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: isImported ? "✓ Imported" : "Import"
              }
            )
          ]
        },
...
function Agent11BusinessDiscovery() {
  ...
  const [businesses, setBusinesses] = reactExports.useState(() => {
    ...
    const realAsUnclaimed = realBizs.map((b) => ({
      id: b.id,
      name: b.name,
      category: b.category,
      city: b.city,
    ...
    const filteredStored = stored.filter(
      (b) => !existingIds.has(b.id) && !realAsUnclaimed.some((r) => r.name === b.name)
    );
  ...
  reactExports.useEffect(() => {
    const refreshLiveBizs = () => {
      ...
      setBusinesses((prev) => {
        ...
        const filtered = prev.filter(
          (b) => !existingNames.has(b.name) || b.status === "Unclaimed" || b.status === "Pending"
        );
        return [
          ...realAsUnclaimed,
          ...filtered.filter(
    ...
    const interval = setInterval(refreshLiveBizs, 3e4);
    return () => {
  ...
  const approveB = (id) => {
    ...
    ue.success("Business approved — added to Family Tree and Business Page");
  };
  const rejectB = (id) => {
    setBusinesses((prev) => {
      const updated = prev.map(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", "data-ocid": "admin.agent11discovery.panel", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3", children: [
      {
        ...
        sub: realCount > 0 ? `${realCount} from your network` : void 0,
        icon: Globe
      },
      {
        label: "Pending Claim",
        value: pendingCount,
        sub: newDiscoveriesCount > 0 ? `${newDiscoveriesCount} new` : void 0,
        icon: Clock
      },
      {
        label: "Claimed",
    ...
    ].map(({ label, value, sub, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-3 flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        sub && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-primary/70 mt-0.5", children: sub })
      ] })
    ] }) }, label)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TabsTrigger,
          {
            value: "find-products",
            "data-ocid": "admin.agent11discovery.tab",
            children: "📦 Find Products"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "config", className: "mt-4 space-y-4", children: [
        realCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-green-500/10 border border-green-500/20 text-xs text-green-700 dark:text-green-400 flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 14, className: "shrink-0 mt-0.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { children: [
              realCount,
              " businesses from your Family Tree"
            ] }),
            " ",
            "are pre-loaded as Claimed.",
            newDiscoveriesCount > 0 && ` ${newDiscoveriesCount} new unclaimed discoveries found.`
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "google-search", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        GoogleBusinessSearchTab,
        {
          onAddToBusiness: (biz) => {
            ...
            ue.success(`${biz.name} added to discovery list`);
          }
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "find-people", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FindPeopleTab, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "find-products", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FindProductsTab, {}) })
    ] }),
