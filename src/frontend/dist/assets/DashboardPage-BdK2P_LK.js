import { k as createLucideIcon, a8 as useCurrency, j as jsxRuntimeExports, T as Tabs, c as TabsList, d as TabsTrigger, e as TabsContent, a3 as ShoppingBag, B as Badge, x as Briefcase, R as Plane, H as Heart, a4 as GraduationCap, al as ExternalLink } from "./index-DRWZCthO.js";
...
import { A as ArrowUpRight } from "./arrow-up-right-BRgmktY9.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: userOrders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "p-8 text-center",
                  "data-ocid": "dashboard.orders.empty_state",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-muted-foreground", children: "No orders yet" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-secondary/30", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-4 py-3 text-xs font-label font-semibold text-muted-foreground", children: "Items" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right px-4 py-3 text-xs font-label font-semibold text-muted-foreground", children: "Total" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: userOrders.slice(0, 10).map((order, idx) => {
                  var _a, _b, _c, _d;
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "tr",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-3 text-xs font-label font-mono text-foreground", children: order.id }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-xs text-muted-foreground", children: new Date(order.date).toLocaleDateString("en-IN", {
                          day: "numeric",
                          month: "short",
                          year: "numeric"
                        }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 text-xs font-label text-foreground", children: [
                          (_a = order.items) == null ? void 0 : _a.slice(0, 2).map((it) => it.name).join(", "),
                          (((_b = order.items) == null ? void 0 : _b.length) ?? 0) > 2 && ` +${(((_c = order.items) == null ? void 0 : _c.length) ?? 0) - 2} more`
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "td",
                          {
                            ...
                            children: [
                              "₹",
                              (_d = order.total) == null ? void 0 : _d.toLocaleString()
                            ]
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            style: order.status === "Delivered" ? {
                              ...
                              background: "oklch(0.62 0.2 230 / 0.12)",
