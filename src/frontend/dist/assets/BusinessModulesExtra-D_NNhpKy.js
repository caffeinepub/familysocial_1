import { c as createLucideIcon, j as jsxRuntimeExports, t as CircleCheck, aa as Clock, r as reactExports, k as Badge, B as Button, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, P as Package, T as Tabs, a as TabsList, b as TabsTrigger, d as TabsContent, w as Dialog, y as DialogContent, z as DialogHeader, A as DialogTitle, L as Label, I as Input, Z as Zap, x as DialogTrigger, ab as Separator, u as ue } from "./index-CTlHP6rz.js";
...
function CourierDispatchModule() {
  ...
  const [editShipId, setEditShipId] = reactExports.useState(null);
  const [editShipOpen, setEditShipOpen] = reactExports.useState(false);
  const [editShipForm, setEditShipForm] = reactExports.useState({
    customer: "",
    origin: "",
    destination: "",
    weight: ""
  ...
  const saveEditShipment = () => {
    setShipments(
      (p) => p.map((s) => s.id === editShipId ? { ...s, ...editShipForm } : s)
    );
    ue.success("Shipment updated");
    setEditShipId(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", "data-ocid": "courier.module.panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "shipments", children: [
            ...
            "tr",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 items-center", children: [
                  s.status !== "Delivered" && s.status !== "Failed" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      size: "sm",
                      variant: "outline",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Edit Shipment" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Customer" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  onChange: (e) => setEditShipForm((p) => ({ ...p, customer: e.target.value })),
                  className: "mt-1"
                }
              )
            ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    ...
                    onChange: (e) => setEditShipForm((p) => ({ ...p, origin: e.target.value })),
                    className: "mt-1"
                  }
                )
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Weight" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  value: editShipForm.weight,
                  onChange: (e) => setEditShipForm((p) => ({ ...p, weight: e.target.value })),
                  className: "mt-1"
                }
              )
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setEditShipOpen(false), children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: saveEditShipment, children: "Save Changes" })
          ] })
        ] })
      }
    )
...
function FuelDepotModule() {
  ...
  const [editFuelId, setEditFuelId] = reactExports.useState(null);
  const [editFuelOpen, setEditFuelOpen] = reactExports.useState(false);
  const [editFuelForm, setEditFuelForm] = reactExports.useState({ stock: "", price: "" });
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { size: 10 }),
                  " Edit"
                ]
              }
            ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { children: [
            "Edit Fuel — ",
            (_a = fuels.find((f) => f.id === editFuelId)) == null ? void 0 : _a.name
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 py-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-xs", children: [
                "Stock (",
                (_b = fuels.find((f) => f.id === editFuelId)) == null ? void 0 : _b.unit,
                ")"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  onChange: (e) => setEditFuelForm((p) => ({ ...p, stock: e.target.value })),
                  className: "mt-1"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-xs", children: [
                "Price per ",
                (_c = fuels.find((f) => f.id === editFuelId)) == null ? void 0 : _c.unit,
                " (₹)"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  ...
                  onChange: (e) => setEditFuelForm((p) => ({ ...p, price: e.target.value })),
                  className: "mt-1"
                }
              )
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setEditFuelOpen(false), children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: saveEditFuel, children: "Save Changes" })
          ] })
        ] })
      }
    ),
            ...
            "tr",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-2", children: [
                  l.qty,
                  " ",
                  (_a2 = fuels.find((f) => f.id === l.fuelId)) == null ? void 0 : _a2.unit
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-2", children: [
                  "₹",
                  l.amount.toFixed(2)
