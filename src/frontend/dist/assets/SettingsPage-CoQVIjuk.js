const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CBRZAwRu.js","assets/index-BKSOHxCA.js","assets/index-f6zMtG2H.css"])))=>i.map(i=>d[i]);
import { k as createLucideIcon, r as reactExports, aW as createDialogScope, j as jsxRuntimeExports, ab as Root, aX as Trigger, aw as useComposedRefs, aY as WarningProvider, au as createContextScope, ac as Content, ay as composeEventHandlers, aZ as createSlottable, af as Title, a_ as Description, ae as Close, ag as Portal, ah as Overlay, ad as cn, a$ as buttonVariants, b0 as useActor, a5 as useInternetIdentity, b1 as loadConfig, aq as __vitePreload, b2 as StorageClient, b3 as useSaveUserProfile, U as User, A as Avatar, b4 as AvatarImage, b as AvatarFallback, b5 as Camera, a as Button, L as Label, I as Input, S as Select, f as SelectTrigger, g as SelectValue, h as SelectContent, i as SelectItem, ak as Shield, $ as Switch, w as Separator, s as Bell, u as ue, aj as LoaderCircle, M as MessageCircle, v as CircleCheck } from "./index-BKSOHxCA.js";
  ...
  const uploadFile = reactExports.useCallback(
    async (file) => {
      ...
      const { HttpAgent } = await __vitePreload(async () => {
        const { HttpAgent: HttpAgent2 } = await import("./index-CBRZAwRu.js").then((n) => n.i);
