const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BNLlZDnb.js","assets/index-DVrwA8ch.js","assets/index-D0RCu0iE.css"])))=>i.map(i=>d[i]);
import { s as createLucideIcon, r as reactExports, az as createDialogScope, j as jsxRuntimeExports, a2 as Root, aA as Trigger, ah as useComposedRefs, aB as WarningProvider, ad as createContextScope, a3 as Content, af as composeEventHandlers, aC as createSlottable, a6 as Title, aD as Description, a5 as Close, a7 as Portal, a8 as Overlay, a4 as cn, aE as buttonVariants, aF as useActor, aa as useInternetIdentity, aG as loadConfig, aH as __vitePreload, aI as StorageClient, aJ as useSaveUserProfile, n as User, A as Avatar, aK as AvatarImage, o as AvatarFallback, a as Button, L as Label, I as Input, S as Select, f as SelectTrigger, g as SelectValue, h as SelectContent, i as SelectItem, T as Textarea, Q as Switch, z as Bell, u as ue, ab as LoaderCircle, p as MessageCircle, C as CircleCheck } from "./index-DVrwA8ch.js";
import { P as Progress } from "./progress-CpT5_cAL.js";
...
import { U as Upload } from "./upload-C3rON3-C.js";
/**
  ...
  const uploadFile = reactExports.useCallback(
    async (file) => {
      ...
      const { HttpAgent } = await __vitePreload(async () => {
        const { HttpAgent: HttpAgent2 } = await import("./index-BNLlZDnb.js").then((n) => n.i);
