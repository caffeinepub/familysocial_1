const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DZnPJGYY.js","assets/index-DyYRv8fY.js","assets/index-DCMQdf4J.css"])))=>i.map(i=>d[i]);
import { k as createLucideIcon, r as reactExports, aG as createDialogScope, j as jsxRuntimeExports, ab as Root, aH as Trigger, aw as useComposedRefs, aI as WarningProvider, as as createContextScope, ac as Content, au as composeEventHandlers, aJ as createSlottable, af as Title, aK as Description, ae as Close, ag as Portal, ah as Overlay, ad as cn, aL as buttonVariants, aM as useActor, a5 as useInternetIdentity, aN as loadConfig, aq as __vitePreload, aO as StorageClient, aP as useSaveUserProfile, U as User, A as Avatar, aQ as AvatarImage, b as AvatarFallback, aR as Camera, a as Button, L as Label, I as Input, S as Select, f as SelectTrigger, g as SelectValue, h as SelectContent, i as SelectItem, ak as Shield, $ as Switch, w as Separator, s as Bell, u as ue, aj as LoaderCircle, M as MessageCircle, v as CircleCheck } from "./index-DyYRv8fY.js";
  ...
  const uploadFile = reactExports.useCallback(
    async (file) => {
      ...
      const { HttpAgent } = await __vitePreload(async () => {
        const { HttpAgent: HttpAgent2 } = await import("./index-DZnPJGYY.js").then((n) => n.i);
