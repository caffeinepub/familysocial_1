import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, k as Badge, B as Button, aa as Clock, T as Tabs, a as TabsList, b as TabsTrigger, d as TabsContent, L as Label, a8 as ScrollArea, u as ue, w as Dialog, y as DialogContent, z as DialogHeader, A as DialogTitle, a6 as DialogFooter, S as ShieldCheck, ab as Separator, I as Input, X as Search, W as Building2, M as MapPin, E as LoaderCircle, x as DialogTrigger, f as Star } from "./index-CTlHP6rz.js";
import { C as Card, a as CardContent, b as CardHeader, c as CardTitle } from "./card-Cq_2D833.js";
import { C as Checkbox } from "./checkbox-CjuE3CBu.js";
...
import { G as Gavel } from "./gavel-BgohycIZ.js";
...
function GoogleBusinessSearchTab({
  ...
  const handleSearch = () => {
    ...
    setTimeout(() => {
      ...
      setResults(found);
      setLoading(false);
      ue.success(`Found ${found.length} ${category} businesses in ${city}`);
    }, 1500);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-blue-500/10 border border-blue-500/20 text-xs text-blue-700 dark:text-blue-400 flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 14, className: "shrink-0 mt-0.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Simulates Google Business Profile API search. In production, connect your Google Places API key in Admin → API Sync to enable real results." })
    ] }),
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-1 text-xs text-muted-foreground", children: [
                ...
                biz.website && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href: biz.website,
                    target: "_blank",
