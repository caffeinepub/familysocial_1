const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CISQ19Eh.js","assets/index-BlytXoNc.js","assets/index-D9dM-sm2.css"])))=>i.map(i=>d[i]);
import { k as createLucideIcon, r as reactExports, aX as createDialogScope, j as jsxRuntimeExports, ab as Root, aY as Trigger, aw as useComposedRefs, aZ as WarningProvider, au as createContextScope, ac as Content, ay as composeEventHandlers, a_ as createSlottable, af as Title, a$ as Description, ae as Close, ag as Portal, ah as Overlay, ad as cn, b0 as buttonVariants, b1 as useActor, a5 as useInternetIdentity, b2 as loadConfig, aq as __vitePreload, b3 as StorageClient, b4 as useSaveUserProfile, U as User, A as Avatar, b5 as AvatarImage, b as AvatarFallback, b6 as Camera, a as Button, L as Label, I as Input, S as Select, f as SelectTrigger, g as SelectValue, h as SelectContent, i as SelectItem, ak as Shield, $ as Switch, w as Separator, s as Bell, u as ue, aj as LoaderCircle, M as MessageCircle, v as CircleCheck } from "./index-BlytXoNc.js";
  ...
  const uploadFile = reactExports.useCallback(
    async (file) => {
      ...
      const { HttpAgent } = await __vitePreload(async () => {
        const { HttpAgent: HttpAgent2 } = await import("./index-CISQ19Eh.js").then((n) => n.i);
