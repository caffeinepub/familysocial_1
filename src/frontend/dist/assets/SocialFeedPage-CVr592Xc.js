...
import { l as createLucideIcon, r as reactExports, a7 as useInternetIdentity, j as jsxRuntimeExports, A as Avatar, b as AvatarFallback, a as Button, an as DropdownMenu, ao as DropdownMenuTrigger, y as Briefcase, n as House, aj as FileText, V as Plane, H as Heart, m as Building2, a5 as ShoppingBag, s as Users, R as TreePine, $ as ChevronDown, ap as DropdownMenuContent, aq as DropdownMenuItem, B as Badge, M as MessageCircle, Z as Zap, ar as __vitePreload, D as Dialog, F as DialogContent, G as DialogHeader, J as DialogTitle } from "./index-CCkd8W3P.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-muted-foreground", children: [
              ...
              " ·",
              " ",
              post.timestamp.includes("T") ? formatTimeAgo(post.timestamp) : post.timestamp
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 pt-1 border-t border-border", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 13, fill: boosted ? "currentColor" : "none" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 lg:p-8 max-w-2xl mx-auto", "data-ocid": "feed.page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: getTabPosts().length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12", "data-ocid": "feed.posts.empty_state", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "No posts in this feed yet. Be the first to share something!" }) }) : (() => {
      ...
      posts.forEach((post, i) => {
        var _a2, _b2, _c2;
        elements.push(
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { animationDelay: `${i * 0.04}s` }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(PostCard, { post }) }, post.id)
        );
          ...
          elements.push(
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-amber-500/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Megaphone, { size: 14, className: "text-amber-600" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-amber-600 uppercase tracking-wider px-1.5 py-0.5 bg-amber-500/15 rounded-full", children: "Promoted" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-muted-foreground", children: [
                          ((_a2 = promo.plan) == null ? void 0 : _a2.charAt(0).toUpperCase()) + ((_b2 = promo.plan) == null ? void 0 : _b2.slice(1)),
                          " ",
                          "Plan"
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mt-0.5 line-clamp-1", children: promo.postTitle })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground pl-10", children: [
                    "Sponsored · ",
                    ((_c2 = promo.regions) == null ? void 0 : _c2.join(", ")) || "All India",
                    " ·",
                    " ",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-1", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        onClick: () => {
                          __vitePreload(async () => {
                            const { toast } = await import("./index-CCkd8W3P.js").then((n) => n.cV);
                            return { toast };
