import { l as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a as Button, B as Badge, al as Shield, s as Users, m as Building2, D as Dialog, E as DialogTrigger, N as Plus, F as DialogContent, G as DialogHeader, J as DialogTitle, L as Label, I as Input, S as Select, f as SelectTrigger, g as SelectValue, h as SelectContent, i as SelectItem, y as Briefcase, u as ue, _ as Search, T as Tabs, c as TabsList, d as TabsTrigger, e as TabsContent, O as MapPin, w as CircleCheck } from "./index-DaHNgtHM.js";
import { T as Textarea } from "./textarea-MNc26vhR.js";
import { E as EventsTab } from "./EventsTab-BBEb1NNU.js";
import { a as addGlobalProduct } from "./globalProductsState-DsVVJw3h.js";
...
function AdminCommunityView() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "visitors", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "marketplace", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CommunityAdminMarketplace, {}) }),
...
function CommunityAdminMarketplace() {
  ...
  const handleSubmit = (e) => {
    ...
    ue.success(`"${form.name}" posted to marketplace and Shop`);
    setForm({
      name: "",
      price: "",
      category: "Home Services",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "form",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: "Post to Marketplace & Shop" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "comm-item-name", className: "text-xs font-medium", children: "Item Name *" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "comm-item-name",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "comm-item-price", className: "text-xs font-medium", children: "Price (₹)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "comm-item-price",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "comm-item-desc", className: "text-xs font-medium", children: "Description" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "comm-item-desc",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: "Post to Marketplace & Shop"
            }
          )
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ResidentView, {})
  ] });
}
