const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CKD6yqAx.js","assets/index-rbU7eNkU.js","assets/index-cb8DWXWW.css"])))=>i.map(i=>d[i]);
import { h as createLucideIcon, r as reactExports, aF as createDialogScope, j as jsxRuntimeExports, a5 as Root, aG as Trigger, aq as useComposedRefs, aH as WarningProvider, am as createContextScope, a6 as Content, ar as composeEventHandlers, aI as createSlottable, a9 as Title, aJ as Description, a8 as Close, aa as Portal, ab as Overlay, a7 as cn, aK as buttonVariants, aL as useActor, ad as useInternetIdentity, aM as loadConfig, al as __vitePreload, aN as StorageClient, aO as useSaveUserProfile, U as User, A as Avatar, aP as AvatarImage, b as AvatarFallback, a as Button, L as Label, I as Input, S as Select, c as SelectTrigger, d as SelectValue, e as SelectContent, f as SelectItem, ag as Shield, R as Switch, t as Separator, p as Bell, u as ue, ae as LoaderCircle, M as MessageCircle, s as CircleCheck } from "./index-rbU7eNkU.js";
import { P as Progress } from "./progress-KjbN4d1I.js";
import { T as Textarea } from "./textarea-BkO4KF3b.js";
import { D as Database } from "./index-CKD6yqAx.js";
  ...
  const uploadFile = reactExports.useCallback(
    async (file) => {
      ...
      const { HttpAgent } = await __vitePreload(async () => {
        const { HttpAgent: HttpAgent2 } = await import("./index-CKD6yqAx.js").then((n) => n.i);
