import { l as createLucideIcon, j as jsxRuntimeExports, y as Briefcase, a as Button, u as ue, o as ShieldCheck, s as Users, T as Tabs, c as TabsList, d as TabsTrigger, e as TabsContent, r as reactExports, H as Heart, U as User, X, I as Input, N as Plus, al as Shield, D as Dialog, E as DialogTrigger, F as DialogContent, G as DialogHeader, J as DialogTitle, L as Label, S as Select, f as SelectTrigger, g as SelectValue, h as SelectContent, i as SelectItem, B as Badge, v as Clock, O as MapPin, w as CircleCheck, W as BookOpen, A as Avatar, b as AvatarFallback, k as Star, aa as ScrollArea, a6 as GraduationCap } from "./index-CCkd8W3P.js";
...
import { A as Activity } from "./activity-BzW2cJan.js";
import { C as CalendarDays } from "./calendar-days-Cg0ODz81.js";
import { S as Stethoscope } from "./stethoscope-Bm2EqDTu.js";
import { D as Droplets } from "./droplets-cGfGlsyU.js";
...
function MedicalRecordsTab({
  ...
  const [diseaseReadings, setDiseaseReadings] = reactExports.useState(
    {
      diabetes: [],
      hypertension: [],
      heart: [],
  ...
  const [diseaseActiveTab, setDiseaseActiveTab] = reactExports.useState("vitals");
  ...
  const [rxMember, setRxMember] = reactExports.useState("Self");
  const [vitalMember, setVitalMember] = reactExports.useState("Self");
  ...
  const [diabetesForm, setDiabetesForm] = reactExports.useState({
    fastingGlucose: "",
    postMealGlucose: "",
    hba1c: "",
    insulin: ""
  });
  const [hypertensionForm, setHypertensionForm] = reactExports.useState({
    systolic: "",
    diastolic: "",
    pulse: "",
    timeOfDay: "Morning"
  });
  const [heartForm, setHeartForm] = reactExports.useState({
    heartRate: "",
    ecgNotes: "",
    chestPain: "None",
    medication: ""
  });
  const [thyroidForm, setThyroidForm] = reactExports.useState({
    tsh: "",
    t3: "",
    t4: "",
    symptoms: ""
  });
  const [kidneyForm, setKidneyForm] = reactExports.useState({
    creatinine: "",
    bun: "",
    egfr: "",
    fluidIntake: ""
  });
  const [respiratoryForm, setRespiratoryForm] = reactExports.useState({
    peakFlow: "",
    o2sat: "",
    difficulty: "None",
    inhalerUsed: false
  ...
  const addVital = (e) => {
    e.preventDefault();
    const now = (/* @__PURE__ */ new Date()).toLocaleDateString("en-IN", {
      day: "2-digit",
      month: "short",
      year: "numeric"
    });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-up animate-fade-up-2", children: [
          ...
          action: /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open: rxOpen, onOpenChange: setRxOpen, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: addPrescription, className: "space-y-4 mt-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Family Member" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: rxMember, onValueChange: setRxMember, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      SelectTrigger,
                      {
                        className: "h-8 text-sm",
                        "data-ocid": "rx.member.select",
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select member" })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: familyMembers.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      SelectItem,
                      {
                        value: m.name,
                        className: "text-sm",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-border rounded-xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-xs font-label", children: "Member" }),
        ...
        SectionHeader,
        {
          ...
          action: /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open: vitalOpen, onOpenChange: setVitalOpen, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-lg", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display", children: "Log Health Reading" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Tabs,
                {
                  ...
                  className: "mt-2",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "w-full flex-wrap h-auto gap-0.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        TabsTrigger,
                        {
                          value: "vitals",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: addVital, className: "space-y-3 mt-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "vitals", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "SpO2 (%)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              type: "number",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "diabetes", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Fasting Glucose (mg/dL)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              type: "number",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Post-meal Glucose (mg/dL)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              type: "number",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "HbA1c (%)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Insulin Dose" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "hypertension", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Systolic (mmHg)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              type: "number",
                              ...
                              onChange: (e) => setHypertensionForm((p) => ({
                                ...p,
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Diastolic (mmHg)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              type: "number",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Time of Day" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            Select,
                            {
                              value: hypertensionForm.timeOfDay,
                              onValueChange: (v) => setHypertensionForm((p) => ({
                                ...p,
                                timeOfDay: v
                              })),
                              children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                                  ...
                                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Night", children: "Night" })
                                ] })
                              ]
                            }
                          )
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "heart", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Heart Rate (bpm)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              type: "number",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Chest Pain" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            Select,
                            {
                              value: heartForm.chestPain,
                              onValueChange: (v) => setHeartForm((p) => ({ ...p, chestPain: v })),
                              children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 text-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 col-span-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "ECG Notes" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 col-span-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Medication Taken" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "thyroid", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "TSH (mIU/L)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "T3" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "T4" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Symptoms" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "kidney", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Creatinine (mg/dL)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "BUN" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "eGFR" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Fluid Intake (ml)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "respiratory", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Peak Flow (L/min)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              className: "h-8 text-sm",
                              ...
                              onChange: (e) => setRespiratoryForm((p) => ({
                                ...p,
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "O2 Saturation (%)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input,
                            {
                              type: "number",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Breathing Difficulty" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            Select,
                            {
                              value: respiratoryForm.difficulty,
                              onValueChange: (v) => setRespiratoryForm((p) => ({
                                ...p,
                                difficulty: v
                              })),
                              children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 flex items-center gap-2 pt-4", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "input",
                            {
                              type: "checkbox",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", className: "w-full font-label mt-2", children: "Log Reading" })
                    ] })
                  ]
                }
              )
    ...
    Object.entries({
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-up mt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-semibold", children: meta.label }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-border rounded-xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: meta.cols.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-xs font-label", children: col }, col)) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: readings.slice(0, 5).map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs text-muted-foreground", children: r.date }),
            key === "diabetes" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.hba1c || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.insulin || "—" })
            ] }),
            key === "hypertension" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                TableCell,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.diastolic || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "text-xs", children: [
                r.pulse || "—",
                " bpm"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.timeOfDay || "—" })
            ] }),
            key === "heart" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "text-xs", children: [
                r.heartRate || "—",
                " bpm"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.chestPain || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.ecgNotes || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.medication || "—" })
            ] }),
            key === "thyroid" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.tsh || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.t3 || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.t4 || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.symptoms || "—" })
            ] }),
            key === "kidney" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.creatinine || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.bun || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.egfr || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.fluidIntake || "—" })
            ] }),
            key === "respiratory" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "text-xs", children: [
                r.peakFlow || "—",
                " L/min"
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.difficulty || "—" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: r.inhalerUsed ? "Yes" : "No" })
            ] })
          ] }, r.id)) })
        ] }) })
      ] }, key);
