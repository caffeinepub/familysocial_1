import { k as createLucideIcon, r as reactExports, j as jsxRuntimeExports, n as ShieldCheck, T as Tabs, c as TabsList, d as TabsTrigger, e as TabsContent, q as Users, o as TriangleAlert, P as Package, Z as Zap, am as DropdownMenu, an as DropdownMenuTrigger, _ as ChevronDown, ao as DropdownMenuContent, ap as DropdownMenuItem, a as Button, B as Badge, L as Label, I as Input, S as Select, f as SelectTrigger, g as SelectValue, h as SelectContent, i as SelectItem, u as ue, a3 as ShoppingBag, $ as Switch, v as CircleCheck, ak as Shield, N as MapPin, D as Dialog, z as DialogTrigger, E as DialogContent, F as DialogHeader, G as DialogTitle, aj as LoaderCircle, V as BookOpen, x as Briefcase, a6 as React } from "./index-DyYRv8fY.js";
import { C as Card, b as CardContent } from "./card-Bqh-H7en.js";
import { C as Checkbox } from "./checkbox-CM_2vayU.js";
import { S as Slider } from "./slider-PBA_vlTf.js";
import { T as Textarea } from "./textarea-BWyyBacq.js";
import { A as Agent11BusinessDiscovery, B as BusinessClaimsAdmin, g as getReviews } from "./ReviewModal-D1k9d8Ac.js";
import { C as CircleX } from "./circle-x-choHQFeV.js";
import { S as Star } from "./star-3nDuNLmy.js";
import { D as Database } from "./index-DZnPJGYY.js";
import { T as TrendingUp } from "./trending-up-C6ZybF_S.js";
import { A as Activity } from "./activity-CB9c8YMg.js";
import { C as Crown } from "./crown-Cflng_bV.js";
...
import { S as Smartphone } from "./smartphone-B7g5d6vx.js";
...
import { E as Ellipsis } from "./ellipsis-CIj1WD35.js";
import { T as Trash2 } from "./trash-2-LwCU6ska.js";
import "./table-86N3mitE.js";
import "./globe-Bb3pBv83.js";
import "./gavel-CFE2duw2.js";
import "./phone-B44akykt.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-3 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "Total Found" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-3 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            style: { color: "oklch(0.52 0.14 155)" },
            children: addedIds.size + connectedBiz.length
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "Added to Platform" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-3 text-center", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", "data-ocid": "admin.promotions.panel", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "targeting", className: "mt-0 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold flex items-center gap-2", children: "🌏 Geographic Targeting" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-3", children: [
            {
              label: "Regions",
              items: [
...
function Agent22ModuleTester() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Tests all module functionality and reports results to admin." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          size: "sm",
          children: runningAll ? "Running..." : "▶ Run All Tests"
        }
      ),
      total > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-medium", children: [
        passing,
        "/",
        total,
        " modules passing"
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: modules.map((mod) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex items-center justify-between bg-card border border-border rounded-xl p-4",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            results[mod] === "pass" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-600 text-base", children: "✓" }) : results[mod] === "fail" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-500 text-base", children: "✗" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-base", children: "○" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: mod })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            results[mod] && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: results[mod] === "idle" ? "running..." : results[mod]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
...
function Agent23NewsAgent() {
  ...
  React.useEffect(() => {
    const interval = setInterval(() => {
      const cat = selectedCats[Math.floor(Math.random() * selectedCats.length)] || "Tech";
      const n = Math.floor(Math.random() * 200) + 50;
      const newLog = `[${(/* @__PURE__ */ new Date()).toLocaleTimeString()}] Fetching news for ${cat}... Posted to ${n} users`;
...
function Agent24FoodStockAgent() {
  ...
  React.useEffect(() => {
    const interval = setInterval(() => {
      ...
      const newLog = `[${(/* @__PURE__ */ new Date()).toLocaleTimeString()}] Scanning ${store} for ${item}... Best price ₹${price} found at ${store}`;
      setLogs((prev) => [newLog, ...prev.slice(0, 29)]);
      setStats((prev) => ({
        scans: prev.scans + 1,
...
function Agent25ContentShield() {
  ...
  React.useEffect(() => {
    const interval = setInterval(() => {
      ...
      const entry = count > 0 ? `[${t}] Scanned ${30 + Math.floor(Math.random() * 20)} posts — ${count} flagged — keywords: "${kw}"` : `[${t}] Scanned ${30 + Math.floor(Math.random() * 20)} posts — 0 flagged`;
...
function BizAnalyticsTab() {
  ...
  const last7 = Array.from({ length: 7 }, (_, i) => {
    ...
    return {
      ...
      commission: Math.floor(Math.random() * 3e3 + 500)
    };
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3", children: [
      ...
      },
      {
        ...
        value: `₹${(totalRevenue / 1e5).toFixed(1)}L`,
...
function EvolutionA4Agent() {
  ...
  const [logs, setLogs] = React.useState([
    `[${(/* @__PURE__ */ new Date()).toLocaleTimeString()}] 🟢 Evolution A4 Agent started`,
    `[${(/* @__PURE__ */ new Date()).toLocaleTimeString()}] ✅ Loaded existing chatbot script v2.1`,
    `[${(/* @__PURE__ */ new Date()).toLocaleTimeString()}] 👁️ Monitoring: Shop, POS, Business, Community, Jobs...`
  ]);
  const logRef = React.useRef(null);
  const [scriptVersion, setScriptVersion] = React.useState(2.3);
  const [lastUpdateSecs, setLastUpdateSecs] = React.useState(0);
  React.useEffect(() => {
    const timer = setInterval(() => setLastUpdateSecs((s) => s + 1), 1e3);
  ...
  React.useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setLogs((prev) => {
        const updated = [
          ...prev,
          `[${(/* @__PURE__ */ new Date()).toLocaleTimeString()}] 🔄 Detected new module: ${mod} — regenerating chatbot script...`,
          `[${(/* @__PURE__ */ new Date()).toLocaleTimeString()}] ✅ Script updated — new /module command added`
        ];
  ...
  React.useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setLogs((prev) => {
        const updated = [
          ...prev,
          `[${(/* @__PURE__ */ new Date()).toLocaleTimeString()}] ${entry}`
        ];
...
`;
  const copyScript = () => {
    navigator.clipboard.writeText(FULL_SCRIPT).then(
      () => ue.success("Script copied to clipboard"),
  ...
  const downloadScript = () => {
    ...
    ue.success("Script downloaded");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "🧬 Evolution A4 Agent — WhatsApp Chatbot Auto-Writer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "This agent monitors all module changes and continuously updates the WhatsApp Business API chatbot script." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Auto-updating chatbot script as modules evolve" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs bg-muted px-2 py-0.5 rounded-full text-muted-foreground", children: [
        "Script v",
        scriptVersion.toFixed(1)
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "config", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "config", className: "mt-0 space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: "Auto-update on module changes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Regenerates chatbot script whenever a module is updated" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Switch,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold mb-3", children: "Modules to Watch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: Object.entries(watchModules).map(([mod, checked]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "label",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: mod })
              ]
            },
            mod
          )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            onClick: () => {
              setLogs((prev) => [
                ...prev,
                `[${(/* @__PURE__ */ new Date()).toLocaleTimeString()}] 🔄 Manual regeneration triggered...`,
                `[${(/* @__PURE__ */ new Date()).toLocaleTimeString()}] ✅ Script regenerated — ${Math.floor(Math.random() * 200 + 900)} lines generated`
              ]);
              ue.success("Script regeneration triggered");
            },
            ...
            children: "🔄 Regenerate Now"
          }
        )
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "activity", className: "mt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-green-600", children: "● LIVE" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Updates every 12s" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "script", className: "mt-0 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-amber-500/10 border border-amber-500/30 rounded-lg p-3 text-xs text-amber-800 dark:text-amber-300", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Deploy:" }),
          " Copy this script to your Node.js server, configure the .env vars, and set your webhook URL in",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Admin → WhatsApp API → Credentials" }),
