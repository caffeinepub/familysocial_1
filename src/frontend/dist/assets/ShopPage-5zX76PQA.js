import { az as useInternetIdentity, r as reactExports, R as React, u as ue, Y as addGlobalProduct, aP as getGlobalProducts, j as jsxRuntimeExports, q as ShoppingBag, B as Button, W as Building2, w as Dialog, x as DialogTrigger, V as Plus, y as DialogContent, z as DialogHeader, A as DialogTitle, aS as DialogDescription, L as Label, I as Input, l as Select, m as SelectTrigger, n as SelectValue, o as SelectContent, p as SelectItem, Q as Info, T as Tabs, a as TabsList, b as TabsTrigger, d as TabsContent, E as LoaderCircle, X as Search, a3 as X, U as Users, k as Badge, P as Package, _ as useCurrency, f as Star, Z as Zap, a9 as ScrollArea, ac as Separator, a5 as ChevronRight, t as CircleCheck, $ as User } from "./index-BVgoOni7.js";
...
import { S as ShopAuctionTab, R as ReviewModal } from "./ReviewModal-Ba0xzi1I.js";
import { L as LikeVoteBar } from "./LikeVoteBar-O_jmeMeB.js";
import { P as PaymentModal } from "./PaymentModal-CLCQIDna.js";
...
import { M as Megaphone } from "./megaphone-DolgMiyt.js";
import { G as Globe } from "./globe-CpFrHdzF.js";
import { W as Wrench } from "./wrench-C3mAVKQ_.js";
import { T as ThumbsUp } from "./thumbs-up-Crh0zupH.js";
...
function ShopProductCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl overflow-hidden hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 flex flex-col group relative", children: [
    ...
    isExternalSource && !isBestBuy && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute top-2 left-2 z-10 flex items-center gap-0.5 text-[9px] px-1.5 py-0.5 rounded-full font-semibold bg-blue-500/90 text-white", children: [
...
function ExternalFoodCard({
  ...
  var _a;
  const category = ((_a = product.categories_tags) == null ? void 0 : _a[0]) ? product.categories_tags[0].replace(/^en:/, "").replace(/-/g, " ") : "Food & Beverages";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-primary/20 rounded-2xl overflow-hidden hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 flex flex-col group relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute top-2 right-2 z-10 flex items-center gap-0.5 text-[9px] px-1.5 py-0.5 rounded-full font-semibold bg-blue-500/90 text-white", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 8 }),
      " Web"
    ] }),
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-36 flex items-center justify-center bg-blue-500/8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { size: 32, className: "text-blue-400 opacity-50" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 flex flex-col flex-1 gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "text-[9px] px-1.5 py-0 border-0 bg-blue-500/12 text-blue-600 dark:text-blue-400 capitalize", children: category.slice(0, 20) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "text-[9px] px-1.5 py-0 gap-0.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 8 }),
          " OpenFoodFacts"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-label font-bold text-foreground text-sm line-clamp-2 group-hover:text-primary transition-colors", children: product.product_name || "Unknown Product" }),
      product.brands && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
        "by ",
        product.brands
      ] }),
...
function BusinessSearchModal({
  ...
  const [shopSheet, setShopSheet] = reactExports.useState(null);
  const handleSearch = reactExports.useCallback(async () => {
    const q = city.trim();
    if (!q) {
      ue.error("Please enter a city name");
      return;
    }
    setLoading(true);
    setResults([]);
    try {
      ...
      const enriched = data.map((b) => ({
        ...b,
        distanceKm: userLocation ? haversineKm(
          userLocation.lat,
          userLocation.lng,
      ...
      if (enriched.length === 0)
        ue.info("No businesses found — try another city or category");
    } catch {
      ue.error("Could not reach OpenStreetMap — showing local results only");
    } finally {
      setLoading(false);
    }
    ...
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Search local businesses via OpenStreetMap" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 14, className: "animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 14 })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollArea, { className: "flex-1 mt-3", children: [
          loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center py-12 gap-2 text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 20, className: "animate-spin" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Searching..." })
          ] }),
          !loading && results.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "Search a city to discover local businesses" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: results.map((biz) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-label font-semibold text-foreground text-sm line-clamp-1", children: biz.display_name.split(",")[0] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground line-clamp-2 mt-0.5", children: biz.display_name })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-1 shrink-0", children: [
                    ...
                    biz.distanceKm !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-primary font-semibold", children: [
                      "~",
                      biz.distanceKm.toFixed(1),
                      " km"
                    ] })
                  ] })
                ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Sheet,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "bottom", className: "h-[60vh]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "font-display text-sm", children: shopSheet == null ? void 0 : shopSheet.display_name.split(",")[0] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-full mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 pb-6", children: [
                "Signature Item",
                "Popular Choice",
                "Daily Special",
                "House Favourite"
              ].map((name) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "bg-card border border-border rounded-xl p-3",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-20 rounded-lg bg-primary/8 flex items-center justify-center mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { size: 20, className: "text-primary/50" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-label font-semibold text-xs text-foreground", children: name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "₹149" })
                  ]
                },
                name
              )) }) })
...
function SellerSearchPanel({
  ...
  const filtered = sellers.filter(
    (s) => s.businessName.toLowerCase().includes(query.toLowerCase()) || s.name.toLowerCase().includes(query.toLowerCase()) || s.category.toLowerCase().includes(query.toLowerCase())
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    SheetContent,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1 px-4 py-3", children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "text-center py-12 text-muted-foreground",
            "data-ocid": "shop.sellers.empty_state",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 32, className: "mx-auto mb-2 opacity-30" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No sellers found" })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: filtered.map((seller) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "bg-card border border-border rounded-xl p-3 flex items-center gap-3",
            "data-ocid": "shop.sellers.card",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 18, className: "text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-label font-semibold text-foreground text-sm truncate", children: seller.businessName }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] px-1.5 py-0.5 rounded-full bg-primary/10 text-primary font-label font-semibold", children: seller.category }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-0.5 text-[10px] text-amber-500 font-semibold", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 9, className: "fill-current" }),
                    " ",
                    seller.rating.toFixed(1)
                  ] }),
                  seller.productCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-muted-foreground", children: [
                    seller.productCount,
                    " products"
                  ] })
                ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  onClick: () => ue.info(`Viewing ${seller.businessName}`),
    ...
    const newOrder = {
      ...
      statusHistory: [
        { status: "Order Placed", timestamp: ts },
        {
          ...
          timestamp: new Date(Date.now() + 2e3).toISOString(),
...
function ShopPage() {
  ...
  const [extFoodResults, setExtFoodResults] = reactExports.useState([]);
  const [extSearchLoading, setExtSearchLoading] = reactExports.useState(false);
  const [bizSearchOpen, setBizSearchOpen] = reactExports.useState(false);
  const [sellerPanelOpen, setSellerPanelOpen] = reactExports.useState(false);
  const searchDebounceRef = reactExports.useRef(null);
  const fetchExternalFood = reactExports.useCallback(async (keyword) => {
    ...
    try {
      ...
      ue.error("Web search unavailable — showing local results only");
      setExtFoodResults([]);
    } finally {
  ...
  const handleAddExternalToShop = reactExports.useCallback((p) => {
    var _a;
    const category = ((_a = p.categories_tags) == null ? void 0 : _a[0]) ? p.categories_tags[0].replace(/^en:/, "").replace(/-/g, " ") : "Food & Beverages";
    addGlobalProduct({
      name: p.product_name,
    ...
    ue.success(`"${p.product_name}" added to your shop!`);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "listings", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 max-w-md", children: [
            extSearchLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              LoaderCircle,
              {
                size: 15,
        ...
        sortedItems.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5", children: (() => {
          const activePromos = (() => {
            try {
              return JSON.parse(
          ...
          const shopPromos = activePromos.filter(
            (p) => ["product", "listing", "post"].includes(p.postType)
          );
          let promoIdx = 0;
          const elements = [];
                  ...
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Megaphone, { size: 12, className: "text-amber-600" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold text-amber-600 uppercase tracking-wider", children: "Sponsored" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground line-clamp-2", children: promo.postTitle }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                        ((_a = promo.plan) == null ? void 0 : _a.charAt(0).toUpperCase()) + ((_b = promo.plan) == null ? void 0 : _b.slice(1)),
                        " ",
                        "Plan · ",
                        ((_c = promo.regions) == null ? void 0 : _c.join(", ")) || "All India"
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-amber-600 font-medium", children: [
                        "~",
                        promo.plan === "premium" ? "10,000" : promo.plan === "standard" ? "2,000" : "500",
                        " ",
                        "impressions"
                      ] })
                    ]
        ...
        searchQuery && extFoodResults.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8", "data-ocid": "shop.web_results.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-1.5 rounded-full border border-blue-400/40 bg-blue-500/8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 13, className: "text-blue-500" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-label font-semibold text-blue-600 dark:text-blue-400", children: [
                "🌐 From Web (",
                extFoodResults.length,
                " results)"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-4", children: 'External results from OpenFoodFacts. Click "Add to My Shop" to save permanently.' }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5", children: extFoodResults.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ExternalFoodCard,
            {
              product: p,
        ...
        extSearchLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex items-center justify-center gap-2 py-6 text-muted-foreground",
            "data-ocid": "shop.web_search.loading",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 16, className: "animate-spin text-primary" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Searching web for food products..." })
            ]
          }
        )
      ] }),
